...
mediawiki_api_endpoint = 'http://wikibase.example.com/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = "https://wdqs-frontend.example.com/proxy/wdqs/bigdata/namespace/wdq/sparql"

# Name of the Wikibase instance
wikibase_name = 'ghhh'

# URL of the main page of the Wikibase instance
wikibase_main_page = 'http://wikibase.example.com/wiki/Main_Page'
...
import re
q_re = re.compile(r'(<?https?:///(entity/|wiki/Item:))?(Q[0-9]+)>?')
q_re_group_id = 3
p_re = re.compile(r'(<?https?:///(entity/|wiki/Property:))?(P[0-9]+)>?')
p_re_group_id = 3
...
identifier_space = 'http://wikibase.example.com/entity/'
schema_space = 'http://wikibase.example.com/prop/direct/'
...
qid_url_pattern = 'http://wikibase.example.com/wiki/Item:{{id}}'
